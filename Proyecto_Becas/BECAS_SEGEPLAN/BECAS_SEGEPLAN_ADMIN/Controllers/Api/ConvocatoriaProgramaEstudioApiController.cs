...
{
    public class ConvocatoriaProgramaEstudioApiController : Controller
    {
        private readonly IConvocatoriaProgramaEstudioData _Repositorio;

        public ConvocatoriaProgramaEstudioApiController(IConvocatoriaProgramaEstudioData repositorio)
        {
        ...
        public IActionResult Insert(int IdConvocatoria, string values)
        {
            ...
            ConvocatoriaProgramaEstudio data = new ConvocatoriaProgramaEstudio();
        ...
        {
            ConvocatoriaProgramaEstudio data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
