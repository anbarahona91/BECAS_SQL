...
{
    public class ConvocatoriaPaisApiController : Controller
    {
        private readonly IConvocatoriaPaisData _Repositorio;

        public ConvocatoriaPaisApiController(IConvocatoriaPaisData repositorio)
        {
        ...
        public object Get(int IdConvocatoria,DataSourceLoadOptions loadOptions)
        {
            ...
            return DataSourceLoader.Load(_Repositorio.ListadoPaisesAsociadoConvocatoria(IdConvocatoria), loadOptions);
        }
        ...
        public IActionResult Insert(int IdConvocatoria,string values)
        {
            ...
            ConvocatoriaPai data = new ConvocatoriaPai();
        ...
        {
            ConvocatoriaPai data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
