...
{
    public class ConvocatoriaApiController : Controller
    {
        private readonly IConvocatoriaData _Repositorio;

        public ConvocatoriaApiController(IConvocatoriaData repositorio)
        {
        ...
        {
            Convocatorium data = new Convocatorium();
        ...
        {
            Convocatorium data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
