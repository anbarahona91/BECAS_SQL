...
{
    public class ConvocatoriaNivelAcademicoApiController : Controller
    {
        private readonly IConvocatoriaNivelAcademicoData _Repositorio;

        public ConvocatoriaNivelAcademicoApiController(IConvocatoriaNivelAcademicoData repositorio)
        {
        ...
        public IActionResult Insert(int IdConvocatoria, string values)
        {
            ...
            ConvocatoriaNivelAcademico data = new ConvocatoriaNivelAcademico();
        ...
        {
            ConvocatoriaNivelAcademico data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
