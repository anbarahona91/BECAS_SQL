...
{
    public class ConvocatoriaDocumentoApiController : Controller
    {
        private readonly IConvocatoriaDocumentoData _Repositorio;

        public ConvocatoriaDocumentoApiController(IConvocatoriaDocumentoData repositorio)
        {
        ...
        public object Get(int IdConvocatoria, DataSourceLoadOptions loadOptions)
        {
            ...
            return DataSourceLoader.Load(_Repositorio.ListadoAsociadoConvocatoria(IdConvocatoria), loadOptions);
        }
        ...
        public IActionResult Insert(int IdConvocatoria, string values)
        {
            ...
            ConvocatoriaDocumento data = new ConvocatoriaDocumento();
        ...
        {
            ConvocatoriaDocumento data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
