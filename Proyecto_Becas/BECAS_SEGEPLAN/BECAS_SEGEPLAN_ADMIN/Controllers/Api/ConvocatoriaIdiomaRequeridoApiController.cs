...
{
    public class ConvocatoriaIdiomaRequeridoApiController : Controller
    {
        private readonly IConvocatoriaIdiomaRequeridoData _Repositorio;

        public ConvocatoriaIdiomaRequeridoApiController(IConvocatoriaIdiomaRequeridoData repositorio)
        {
        ...
        public IActionResult Insert(int IdConvocatoria, string values)
        {
            ...
            ConvocatoriaIdiomaRequerido data = new ConvocatoriaIdiomaRequerido();
        ...
        {
            ConvocatoriaIdiomaRequerido data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
