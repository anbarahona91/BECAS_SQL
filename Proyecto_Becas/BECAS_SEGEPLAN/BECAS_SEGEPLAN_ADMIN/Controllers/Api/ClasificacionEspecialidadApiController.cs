...
{
    public class ClasificacionEspecialidadApiController : Controller
    {
        private readonly IClasificacionEspecialidadData _Repositorio;

        public ClasificacionEspecialidadApiController(IClasificacionEspecialidadData repositorio)
        {
        ...
        {
            ClasificacionEspecialidad data = new ClasificacionEspecialidad();
        ...
        {
            ClasificacionEspecialidad data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
