...
{
    public class ProgramaAcademicoApiController : Controller
    {
        private readonly IProgramaAcademicoData _Repositorio;

        public ProgramaAcademicoApiController(IProgramaAcademicoData repositorio)
        {
        ...
        {
            ProgramaAcademico data = new ProgramaAcademico();
        ...
        {
            ProgramaAcademico data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
