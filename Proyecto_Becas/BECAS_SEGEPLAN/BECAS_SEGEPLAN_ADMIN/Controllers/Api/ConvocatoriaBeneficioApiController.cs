...
{
    public class ConvocatoriaBeneficioApiController : Controller
    {
        private readonly IConvocatoriaBeneficioData _Repositorio;

        public ConvocatoriaBeneficioApiController(IConvocatoriaBeneficioData repositorio)
        {
        ...
        public IActionResult Insert(int IdConvocatoria, string values)
        {
            ...
            ConvocatoriaBeneficio data = new ConvocatoriaBeneficio();
        ...
        {
            ConvocatoriaBeneficio data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
