...
{
    public class ConvocatoriaEnlaceApiController : Controller
    {
        private readonly IConvocatoriaEnlaceData _Repositorio;

        public ConvocatoriaEnlaceApiController(IConvocatoriaEnlaceData repositorio)
        {
        ...
        public IActionResult Insert(int IdConvocatoria, string values)
        {
            ...
            ConvocatoriaEnlace data = new ConvocatoriaEnlace();
        ...
        {
            ConvocatoriaEnlace data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
