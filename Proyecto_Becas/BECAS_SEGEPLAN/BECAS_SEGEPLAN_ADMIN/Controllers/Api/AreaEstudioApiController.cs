...
{
    public class AreaEstudioApiController : Controller
    {
        private readonly IAreaEstudioData _Repositorio;

        public AreaEstudioApiController(IAreaEstudioData repositorio)
        {
        ...
        {
            AreaEstudio data = new AreaEstudio();
        ...
        {
            AreaEstudio data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
