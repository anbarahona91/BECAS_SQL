...
{
    public class ConvocatoriaIdiomaApiController : Controller
    {
        private readonly IConvocatoriaIdiomaData _Repositorio;

        public ConvocatoriaIdiomaApiController(IConvocatoriaIdiomaData repositorio)
        {
        ...
        public IActionResult Insert(int IdConvocatoria, string values)
        {
            ...
            ConvocatoriaIdioma data = new ConvocatoriaIdioma();
        ...
        {
            ConvocatoriaIdioma data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
