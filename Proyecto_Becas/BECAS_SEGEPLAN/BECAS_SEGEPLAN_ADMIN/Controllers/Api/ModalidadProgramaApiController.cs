...
{
    public class ModalidadProgramaApiController : Controller
    {
        private readonly IModalidadProgramaData _Repositorio;

        public ModalidadProgramaApiController(IModalidadProgramaData repositorio)
        {
        ...
        {
            ModalidadPrograma data = new ModalidadPrograma();
        ...
        {
            ModalidadPrograma data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
