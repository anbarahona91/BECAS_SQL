...
{
    public class PublicoApiController : Controller
    {
        private readonly IPublicoData _Repositorio;

        public PublicoApiController(IPublicoData repositorio)
        {
        ...
        {
            Publico data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
