...
{
    public class ConvocatoriaFinabeceGastoFamiliarApiController : Controller
    {
        private readonly IConvocatoriaFinabeceGastoFamiliarData _Repositorio;

        public ConvocatoriaFinabeceGastoFamiliarApiController(IConvocatoriaFinabeceGastoFamiliarData repositorio)
        {
        ...
        {
            ConvocatoriaFinabeceGastoFamiliar data = new ConvocatoriaFinabeceGastoFamiliar();
        ...
        {
            ConvocatoriaFinabeceGastoFamiliar data = _Repositorio.ObtenerId(key);
            JsonConvert.PopulateObject(values, data);
            RespuestaCRUD respuesta = new RespuestaCRUD();
